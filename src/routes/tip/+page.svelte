...
<div
    class="max-w-2xl mx-auto flex flex-col md:flex-row gap-6 md:gap-8 border border-slate-200 bg-white rounded-3xl p-6 md:p-8 shadow-sm"
>
    <div class="flex-1 space-y-8">
        ...
        <div>
            ...
            >
            <div class="relative">
                <div class="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-bold">
                    $
                </div>
                <input
                    id="billAmount"
                    ...
                    min="0"
                    placeholder="0.00"
                    class="w-full bg-slate-50 border border-slate-200 rounded-2xl pl-8 pr-4 py-4 text-xl font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:bg-white transition-all shadow-inner"
                />
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex items-center gap-4">
                ...
                />
                <div
                    class="w-16 bg-slate-50 border border-slate-200 rounded-xl px-2 py-2 flex items-center justify-center"
                >
                    <span class="font-bold text-slate-700">{tipPercentage}%</span>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            >
                ...
                <span class="bg-slate-100 text-slate-600 px-2 py-0.5 rounded font-bold"
                    >{numPeople}</span
                >
            </label>
            <div class="flex items-center gap-3">
                <button
                    ...
                    class="w-12 h-12 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-100 hover:text-slate-800 transition-colors"
                >
                ...
                <div class="flex-1 relative">
                    ...
                    <input
                        ...
                        min="1"
                        class="w-full bg-slate-50 border border-slate-200 rounded-xl pl-12 pr-4 py-3 text-lg font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:bg-white transition-all text-center"
                    />
                </div>

                <button
                    on:click={() => numPeople++}
                    class="w-12 h-12 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-100 hover:text-slate-800 transition-colors relative"
                >
    ...
    <div
        class="md:w-[300px] bg-slate-900 rounded-2xl p-6 text-white shadow-xl flex flex-col justify-between relative overflow-hidden"
    >
        <div
