...
<div
    class="min-h-screen bg-[#0B1120] text-white pb-32 pt-28 px-4 md:px-8 font-poppins"
>
    <!-- Header -->
        ...
        {:else}
            ...
            >
                ...
                <p class="text-slate-400 mb-8 max-w-md mx-auto">
                    Explora la colección y dale al corazón para guardar tus
                    canciones preferidas aquí.
                </p>
                <a
                    href="/coleccion"
