...
<div class="min-h-screen bg-midnight-900 text-white p-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold mb-2">Gestión de Verificación</h1>
                <p class="text-slate-400">
                    Marca usuarios como artistas verificados
                </p>
            </div>
            <a
                href="/admin"
                class="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-xl border border-white/20 transition-colors"
            >
                ← Volver al Admin
            </a>
        </div>
