            ...
            {#each submissions as sub}
                ...
                >
                    <div class="absolute top-4 right-4 flex gap-2">
                        ...
                        {:else if sub.submissionType === 'firebase_direct'}
                            <span
                    ...
                    <div class="flex flex-col md:flex-row gap-6 mb-6">
                        <div class="w-32 h-32 flex-shrink-0 rounded-xl overflow-hidden bg-black/50">
                            {#if sub.coverUrl}
                                <img
                                    src={sub.coverUrl}
                    ...
                    <div class="bg-black/20 rounded-xl p-6">
                                ...
                                {#each sub.r2AudioKeys as track, i}
                                    ...
                                    >
                                        ...
                                        <div class="flex-1 overflow-hidden">
                                            <p class="font-bold text-sm truncate text-white">
                                                {track.name}
                                            </p>
                        ...
                        {:else if sub.submissionType === 'firebase_direct' && sub.audioFiles}
                            <div class="space-y-2">
                                {#each sub.audioFiles as track, i}
                                    <div
                                        class="flex items-center gap-4 bg-white/5 p-3 rounded-lg border border-white/5 hover:border-white/10 transition-all"
                                    >
                                        <button
                                            on:click={() => playDirectAudio(track.key, track.key)}
                                            class="w-10 h-10 rounded-full flex items-center justify-center transition-all {playingKey ===
                                            track.key
                                                ? 'bg-primary-500 text-white shadow-lg shadow-primary-500/20'
                                                : 'bg-white/10 text-white hover:bg-white/20'}"
                        ...
                        {:else if sub.downloadLink}
                            ...
                            >
                                <div class="flex-1 w-full overflow-hidden">
                                    <p class="text-xs text-slate-500 mb-1">Enlace de Descarga</p>
                                    <a
                                ...
                                <div class="flex gap-2 w-full sm:w-auto">
                                    <button
                                        on:click={() => {
                                            navigator.clipboard.writeText(sub.downloadLink || '');
                        ...
                        <div>
                            <p class="text-xs text-slate-500 mb-2">Tracklist Declarado</p>
                            <pre
